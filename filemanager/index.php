...
$imagoToolContext = domainToolAuthorize('filemanager');
...
if (ini_set('open_basedir', $imagoOpenBasedir) === false) {
    throw new RuntimeException('Cannot restrict File Manager directory');
}
...
// Authentication is provided by ImagoPanel DomainToolAccess.
$auth_users = array();
...
$root_path = (string) $imagoToolContext['documentRoot'];

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = trim(dirname((string) ($_SERVER['SCRIPT_NAME'] ?? '')), '/');
...
// Browser resources are bundled locally so the tool works without CDN access.
$external = array(
    'css-bootstrap' => '<link href="assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">',
    'css-dropzone' => '<link href="assets/vendor/dropzone/dropzone.min.css" rel="stylesheet">',
    'css-font-awesome' => '<link rel="stylesheet" href="assets/vendor/font-awesome/css/font-awesome.min.css">',
    'css-highlightjs' => '<link rel="stylesheet" href="assets/vendor/highlight.js/styles/' . $highlightjs_style . '.min.css">',
    'js-ace' => '<script src="assets/vendor/ace/ace.js"></script>',
    'js-bootstrap' => '<script src="assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>',
    ...
    'js-highlightjs' => '<script src="assets/vendor/highlight.js/highlight.min.js"></script>',
    'pre-jsdelivr' => '',
    'pre-cloudflare' => ''
);
